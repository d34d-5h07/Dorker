...
*
*---------Modified By B14CKM4RK373R---------
*----------Added Extra Feautures---------- 
**/
define('CSE_TOKEN', 'partner-pub-2698861478625135:3033704849');
    ...
    function banner (){
print".___  ___.  __________   ___  _______   ______   .______       __  ___  _______ .______\n";      
print"|   \/   | |   ____\  \ /  / |       \ /  __  \  |   _  \     |  |/  / |   ____||   _  \n";
print"|  \  /  | |  |__   \  V  /  |  .--.  |  |  |  | |  |_)  |    |  '  /  |  |__   |  |_)  | \n";
print"|  |\/|  | |   __|   >   <   |  |  |  |  |  |  | |      /     |    <   |   __|  |      /     \n";
print"|  |  |  | |  |____ /  .  \  |  '--'  |  `--'  | |  |\  \----.|  .  \  |  |____ |  |\  \----.\n";
print"|__|  |__| |_______/__/ \__\ |_______/ \______/  | _| `._____||__|\__\ |_______|| _| `._____|\n";
print"                  Version 1.0    |   By B14CKM4RK373R \n\n\n                    ";                                                                                             
}
    banner();
    ...
    while(true){
        ...
        if($trackUrl[1] != NULL){
            foreach($trackUrl[1] as $index => $key){
                echo "[+] Added: ".urldecode(get_string($key, '&q=', '&sa'))."\n";
                $f = fopen("grab.txt","a");
                fwrite($f,urldecode(get_string($key, '&q=', '&sa'))."\n");
                fclose($f);
            }
        }else{
            echo "{!} DONE!\n";
